...
model = load_model('D:\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\cnn8grps_rad1_model.h5')

# Constants
OFFSET = 29
STEP = 1
WHITE_IMG_PATH = "D:\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\white.jpg"
WHITE_IMG = np.ones((400, 400), np.uint8) * 255

# Create white background image if not exists
...
while True:
    try:
        ...
        if hands:
            ...
            # Read white background for drawing hand landmarks
            ...
            if handz:
                ...
                conditions = [
                    ([5, 2], [5, 3], [3, 5], [3, 6], [3, 0], [3, 2], [6, 4], [6, 1], [6, 2], [6, 6], [6, 7], [6, 0], [6, 5], [4, 1], [1, 0], [1, 1], [6, 3], [1, 6], [5, 6], [5, 1], [4, 5], [1, 4], [1, 5], [2, 0], [2, 6], [4, 6], [1, 0], [5, 7], [1, 6], [6, 1], [7, 6], [2, 5], [7, 1], [5, 4], [7, 0], [7, 5], [7, 2])
                ]

                # Custom conditions and logic can be placed here...
